...
SimpleDataTypeConverter::SimpleDataTypeConverter(){}

string SimpleDataTypeConverter::serialize(shared_ptr<DataType> dataType){
    nlohmann::json j;
    j["_type"]  = "dataType";
...
shared_ptr<DataType> SimpleDataTypeConverter::parse(string JSON){
